// const { Fondation, User } = require('../models');

// // function newPost(text, userId, themeId) {
// //     return Fondation.create({ text, userId, themeId })
// //         .then(post => {
// //             return Promise.all([
...
// function createFondation(req, res, next) {
...
// function getFondations(req, res, next) {
//     Fondation.find()
//         .populate('userId')
//         .then(fondations => res.json(fondations))
//         .catch(next);
// }
